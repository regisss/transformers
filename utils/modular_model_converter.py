...
def convert_modular_file(modular_file, source_library: str = "transformers"):
...
if __name__ == "__main__":
    ...
    for file_name in priority_list:
        ...
        converted_files = convert_modular_file(file_name, source_library=args.source_library)
